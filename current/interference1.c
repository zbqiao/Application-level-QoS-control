...
int main (int argc, const char **argv)
{
	...
	*/
    ...
    char object_name[32]="qwer";
    printf("Interference start!\n");
    gettimeofday(&tf,NULL);
    results[0] = 30.0;
    results[1] = 30+((tf.tv_sec*1000 + tf.tv_usec/1000)-(ts.tv_sec*1000 + ts.tv_usec/1000))/1000.0;
    ...
    FILE *fpWrite=fopen("noise2.txt","w"); 
    if(fpWrite==NULL)  
    {  
        return 0; 
    }
